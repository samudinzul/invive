...
<div><form action="home.php"align="center">
    <button type="submit"  >Back to Home</button><a href="buy_merch.php" class="button">Go to Merch </a>
</form></div><br><br>
...
<!-- Products List Start -->
<?php
$results = $mysqli->query("SELECT * FROM songs ORDER BY username,title ASC");
if($results){ 
...
$products_item .= <<<EOT
	...
	<div class="product-thumb"><img src="{$obj->upload2}" width="100" height="100"></div>
